...
from . import TRTInference
from .rect import as_tlbr, aspect_ratio, to_tlbr, get_size, area
from .rect import enclosing, multi_crop, iom, diou_nms
...
class YOLODetector(Detector):
    def __init__(self, size,
        ...
        # print("NMS ISSSSSS =",self.nms_thresh)
        assert max_area >= 0
        self.max_area = max_area
