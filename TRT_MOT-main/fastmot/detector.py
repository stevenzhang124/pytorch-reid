...
class SSDDetector(Detector):
    def __init__(self, size, config, cuda_ctx=None):
        super().__init__(size)
        ...
        self.backend = InferenceBackend(self.model, self.batch_size, self.cuda_ctx)
...
class YoloDetector(Detector):
    def __init__(self, size, config, cuda_ctx=None):
        ...
        self.backend = InferenceBackend(self.model, 1, self.cuda_ctx)
