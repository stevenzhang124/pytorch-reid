...
class VideoIO:
    ...
    def __init__(self, size, config, input_uri, camera_num, output_uri=None, proc_fps=30):
        self.size = size
    ...
    def _parse_uri(self, uri):
        ...
        if '/dev/video' in uri:
            ...
            self.input_uri = "rtsp://admin:edge1234@192.168.1." + self.camera_num + ":554/cam/realmonitor?channel=1&subtype=0"
            protocol = Protocol.RTSP
        else:
