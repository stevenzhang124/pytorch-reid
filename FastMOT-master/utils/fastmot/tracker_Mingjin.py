...
#                         self.movementDirection(1,"A2", track)
#                 elif track.confirmed and self.camera == "106":
#                     if self.doorThreshold(x, y, track, '106'):
#                         self.movementDirection(1,"B2", track)
#                 elif track.confirmed and self.camera == "115":
#                     if self.doorThreshold(x, y, track, '115'):
#                         self.movementDirection(0,"C2", track)
...
#     def movementDirection(self, direction, doorname, track): # direction:  1(in), 0(out)
#         if direction == 1:
